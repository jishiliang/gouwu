...
<table id="dg" title="标签管理" class="easyui-datagrid" fitColumns="true" 
    pagination="true" rownumbers="true" url="tag_list.action" fit="true" toolbar="#tb">
    <thead>
    	<tr>
...
<div id="tb">
	...
	<div>
		&nbsp;标签名称：&nbsp;<input type="text" name="s_tag.name"  id="s_tagName"  size="20" onkeydown="if(event.keyCode==13) searchTag()"/>
