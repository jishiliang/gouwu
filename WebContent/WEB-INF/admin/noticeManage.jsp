...
<table id="dg" title="公告管理" class="easyui-datagrid" fitColumns="true" 
    pagination="true" rownumbers="true" url="notice_list.action" fit="true" toolbar="#tb">
    <thead>
    	<tr>
...
<div id="tb">
	...
	<div>
		&nbsp;公告名称：&nbsp;<input type="text" name="s_notice.name"  id="s_noticeTitle"  size="20" onkeydown="if(event.keyCode==13) searchNotice()"/>
  ...
  <form id="fm" method="post">
  	<table cellspacing="8px;">
  		...
  		<tr>
  			...
  			<td colspan="4">
  				<textarea class="ckeditor" id="content" name="notice.content"  ></textarea>
