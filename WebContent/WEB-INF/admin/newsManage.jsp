...
<table id="dg" title="新闻管理" class="easyui-datagrid" fitColumns="true" 
    pagination="true" rownumbers="true" url="news_list.action" fit="true" toolbar="#tb">
    <thead>
    	<tr>
...
<div id="tb">
	...
	<div>
		&nbsp;新闻名称：&nbsp;<input type="text" name="s_news.name"  id="s_newsTitle"  size="20" onkeydown="if(event.keyCode==13) searchNews()"/>
  ...
  <form id="fm" method="post">
  	<table cellspacing="8px;">
  		...
  		<tr>
  			...
  			<td colspan="4">
  				<textarea class="ckeditor" id="content" name="news.content"  ></textarea>
