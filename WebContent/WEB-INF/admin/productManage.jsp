...
<div id="dlg" class="easyui-dialog" style="width: 670px;height: 500px;padding: 10px 20px"
  ...
  <form id="fm" method="post"  enctype="multipart/form-data">
  	<table cellspacing="8px;">
  	    ...
  	    <tr>
  			<td>所属大类：</td>
  			<td colspan="4"><input class="easyui-combobox" id="bName" name="product.bigType.id"  data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'name',url:'bigType_comboList.action'"/></td>
  		</tr>
  		<tr>
  			<td>所属小类：</td>
